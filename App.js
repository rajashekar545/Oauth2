...
const config = {
  issuer: 'https://stage.smartpass.government.net.ae/secure/oauth2/authorize?realm=/TRA&response_type=code',
  clientId: 'adm',
  redirectUrl: 'ae.abudhabi.dma.dev.singlewindow://msServices_ADM/HomeScreen',
  scopes: ['openid', 'email']

  // serviceConfiguration: {
    // authorizationEndpoint: 'https://stage.smartpass.government.net.ae/secure/oauth2/authorize',
